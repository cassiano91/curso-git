...
//		System.out.println(Json.toJson(args));
		...
		System.out.println(Arquivo.executarComando("git --git-dir=" + caminho + "\\.git pull"));
		...
		obj.setUsername(Arquivo.executarComando("git config user.name"));
		obj.setUseremail(Arquivo.executarComando("git config user.email"));
